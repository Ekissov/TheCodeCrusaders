...
namespace ButiksSystem {
    ...
    public partial class Saanneeha_dk_db_databaseDataSet : global::System.Data.DataSet {
        ...
        public partial class CustomerTableDataTable : global::System.Data.TypedTableBase<CustomerTableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public CustomerTableRow AddCustomerTableRow(string FirstName, string LastName, string PhoneNumber, string Email, string CustomerAddress, int PostalCode, string City) {
...
namespace ButiksSystem.Saanneeha_dk_db_databaseDataSetTableAdapters {
    ...
    public partial class CustomerTableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[CustomerTable] ([FirstName], [LastName], [PhoneNumber], [Email], [CustomerAddress], [PostalCode], [City]) VALUES (@FirstName, @LastName, @PhoneNumber, @Email, @CustomerAddress, @PostalCode, @City);
SELECT CustomerID, FirstName, LastName, PhoneNumber, Email, CustomerAddress, PostalCode, City FROM CustomerTable WHERE (CustomerID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[CustomerTable] SET [FirstName] = @FirstName, [LastName] = @LastName, [PhoneNumber] = @PhoneNumber, [Email] = @Email, [CustomerAddress] = @CustomerAddress, [PostalCode] = @PostalCode, [City] = @City WHERE (([CustomerID] = @Original_CustomerID) AND ([FirstName] = @Original_FirstName) AND ([LastName] = @Original_LastName) AND ([PhoneNumber] = @Original_PhoneNumber) AND ([Email] = @Original_Email) AND ([CustomerAddress] = @Original_CustomerAddress) AND ([PostalCode] = @Original_PostalCode) AND ([City] = @Original_City));
SELECT CustomerID, FirstName, LastName, PhoneNumber, Email, CustomerAddress, PostalCode, City FROM CustomerTable WHERE (CustomerID = @CustomerID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ButiksSystem.Properties.Settings.Default.Saanneeha_dk_db_databaseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT CustomerID, FirstName, LastName, PhoneNumber, Email, CustomerAddress, Post" +
                "alCode, City FROM dbo.CustomerTable";
        ...
        public virtual int Fill(Saanneeha_dk_db_databaseDataSet.CustomerTableDataTable dataTable) {
        ...
        public virtual Saanneeha_dk_db_databaseDataSet.CustomerTableDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Saanneeha_dk_db_databaseDataSet.CustomerTableDataTable dataTable = new Saanneeha_dk_db_databaseDataSet.CustomerTableDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Saanneeha_dk_db_databaseDataSet.CustomerTableDataTable dataTable) {
        ...
        public virtual int Delete(int Original_CustomerID, string Original_FirstName, string Original_LastName, string Original_PhoneNumber, string Original_Email, string Original_CustomerAddress, int Original_PostalCode, string Original_City) {
        ...
        public virtual int Insert(string FirstName, string LastName, string PhoneNumber, string Email, string CustomerAddress, int PostalCode, string City) {
            if ((FirstName == null)) {
        ...
        public virtual int Update(
            ...
            this.Adapter.UpdateCommand.Parameters[13].Value = ((int)(Original_PostalCode));
            if ((Original_City == null)) {
                throw new global::System.ArgumentNullException("Original_City");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FirstName, string LastName, string PhoneNumber, string Email, string CustomerAddress, int PostalCode, string City, int Original_CustomerID, string Original_FirstName, string Original_LastName, string Original_PhoneNumber, string Original_Email, string Original_CustomerAddress, int Original_PostalCode, string Original_City) {
            return this.Update(FirstName, LastName, PhoneNumber, Email, CustomerAddress, PostalCode, City, Original_CustomerID, Original_FirstName, Original_LastName, Original_PhoneNumber, Original_Email, Original_CustomerAddress, Original_PostalCode, Original_City, Original_CustomerID);
        }
    }
