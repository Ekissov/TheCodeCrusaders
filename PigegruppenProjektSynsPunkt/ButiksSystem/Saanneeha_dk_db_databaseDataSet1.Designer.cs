...
namespace ButiksSystem {
    ...
    public partial class Saanneeha_dk_db_databaseDataSet : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/Saanneeha_dk_db_databaseDataSet1.xsd";
...
namespace ButiksSystem.Saanneeha_dk_db_databaseDataSetTableAdapters {
    ...
    public partial class CustomerTableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[CustomerTable] WHERE (([CustomerID] = @Original_CustomerID) AN" +
                "D ([FirstName] = @Original_FirstName) AND ([LastName] = @Original_LastName))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[CustomerTable] SET [FirstName] = @FirstName, [LastName] = @LastName WHERE (([CustomerID] = @Original_CustomerID) AND ([FirstName] = @Original_FirstName) AND ([LastName] = @Original_LastName));
SELECT CustomerID, FirstName, LastName FROM CustomerTable WHERE (CustomerID = @CustomerID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT CustomerID, FirstName, LastName FROM dbo.CustomerTable";
